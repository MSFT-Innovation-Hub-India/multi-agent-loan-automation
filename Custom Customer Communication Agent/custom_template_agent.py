...
project_client = AIProjectClient.from_connection_string(
    ...
    conn_str="eastus2.api.azureml.ms;055cefeb-8cfd-4996-b2d5-ee32fa7cf4d4;rg-kushikote-9315_ai;docstorage")

# Get the agent
agent = project_client.agents.get_agent("asst_7ZkE8erXbttc9OJ9qaPE8Sj9")
